...
class FalsePosRateCheckApp:
    ...
    def main(self):
        ...
        train_list = sorted(
            series_set - val_set) if self.cli_args.include_train else []
        ...
        for _series_ndx, series_uid in series_iter:
            ...
            for batch_ndx, batch_tup in enumerate(cls_dl):
                ...
                for i, _series_uid in enumerate(series_list):
                    ...
                    results_list.append(
                        (center_t[i], probability_t[i, 0].item()))
            ...
            for candidateInfo_tup in candidateInfo_list:
                ...
                for result_ndx, (result_center_irc_t, nodule_probability_t) in enumerate(results_list):
                    result_center_xyz = irc2xyz(
                        result_center_irc_t, ct.origin_xyz, ct.vxSize_xyz, ct.direction_a)
                    delta_xyz_t = torch.tensor(
                        result_center_xyz) - torch.tensor(candidateInfo_tup.center_xyz)
                ...
                if min_dist[0] < distance_cutoff:
                    ...
                    log.warning("!!! Missed positive {}; {} min dist !!!".format(
    ...
    def _make_circle_conv(self, radius):
        ...
        conv = nn.Conv3d(1, 1, kernel_size=(1, diameter, diameter),
                         padding=(0, radius, radius), bias=False)
